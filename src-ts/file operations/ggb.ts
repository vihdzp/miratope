 ...
 */
PolytopeB.prototype.saveAsGGB = function(wireframe: boolean): void {
  ...
  FileOperations.fileName = Translation.firstToUpper(P.getName()) + ".ggb";

  //Save file.
  ggb.file("geogebra.xml", file);
  ggb.generateAsync({type:"blob"}).then(FileOperations.saveBlob);
};
