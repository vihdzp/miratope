...
export class Ending {
	...
	constructor(string: string, sliceDepth: number | CustomFunctionType, newEnding?: string, genderModificationType?: GenderModificationType) {
		this.string = string;
	...
	static compare(name: string, endingStr: string, k: number) {
		let i = name.length - k,
