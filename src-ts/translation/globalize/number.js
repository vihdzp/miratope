...
var numberFormatProperties = function( pattern, cldr, options ) {
	...
	function getLanguageOptions( attribute, propertyIndex ) {
	...
	getLanguageOptions( "minimumIntegerDigits", 2 );
	getLanguageOptions( "minimumFractionDigits", 3 );
	getLanguageOptions( "maximumFractionDigits", 4 );
	getLanguageOptions( "minimumSignificantDigits", 5 );
	getLanguageOptions( "maximumSignificantDigits", 6 );
