 ...
 */
polytopeTypes_1.PolytopeB.prototype.saveAsGGB = function (wireframe) {
    ...
    const center = P.gravicenter().coordinates;
    ...
    globalThis.fileName = translation_1.Translation.firstToUpper(P.getName()) + ".ggb";
    //Save file.
