 ...
 */
export default abstract class Build {
  /**
  ...
  static uniformAntiprism(n: number, d = 1): PolytopeB {
    ...
    return new PolytopeC(
      newElementList,
      new CNAntiprism(Build.regularPolygon(n, d).construction)
    );
  }
  ...
  static cupola(n: number, d: number): PolytopeB {
    ...
    return new PolytopeC(
      newElementList,
      new CNCupola(Build.regularPolygon(n, d).construction)
    );
  }
  ...
  static cuploid(n: number, d: number): PolytopeB {
    ...
    return new PolytopeC(
      newElementList,
      new CNCuploid(Build.regularPolygon(n, d).construction)
    );
  }
  ...
  static cupolaicBlend(n: number, d: number): PolytopeB {
    ...
    return new PolytopeC(
      newElementList,
      new CNCupolaicBlend(Build.regularPolygon(n, d).construction)
    );
  }
