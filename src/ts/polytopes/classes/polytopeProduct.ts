...
export default abstract class PolytopeProduct {
  ...
  static prism(...P: PolytopeB[]): PolytopeB {
    return PolytopeProduct._product(
      P,
      CNType.Multiprism,
      PolytopeProduct._prism
    );
  }
  ...
  private static _prism(P: PolytopeB, Q: PolytopeB): PolytopeB {
    ...
    if (!P_.elementList[0] || !Q_.elementList[0])
  ...
  private static _product(
    ...
    let res = P.pop();
    if (!res) return PolytopeBuild.nullitope();
