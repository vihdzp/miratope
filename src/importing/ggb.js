...
Polytope.prototype.saveAsGGB = function() {
	...
	file = '<?xml version="1.0" encoding="utf-8"?><geogebra format="5.0" version="5.0.609.0" app="classic" platform="d" id="be4bb306-7dca-450f-9a95-cbe8a1c001b5"  xsi:noNamespaceSchemaLocation="http://www.geogebra.org/apps/xsd/ggb.xsd" xmlns="" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ><gui><window width="1366" height="728" /><perspectives><perspective id="tmp"><panes><pane location="" divider="0.15" orientation="1" /></panes><views><view id="4097" visible="false" inframe="true" stylebar="true" location="1,1,1,1" size="400" window="333,109,700,550" /><view id="1" visible="false" inframe="false" stylebar="false" location="1,3" size="884" window="100,100,600,400" /><view id="4" toolbar="0 || 2020 , 2021 , 2022 , 66 || 2001 , 2003 , 2002 , 2004 , 2005 || 2040 , 2041 , 2042 , 2044 , 2043" visible="false" inframe="false" stylebar="false" location="1,1" size="300" window="100,100,600,400" /><view id="8" toolbar="1001 | 1002 | 1003  || 1005 | 1004 || 1006 | 1007 | 1010 || 1008 1009 || 66 68 || 6" visible="false" inframe="false" stylebar="false" location="1,3" size="300" window="100,100,600,400" /><view id="2" visible="true" inframe="false" stylebar="false" location="3" size="200" tab="ALGEBRA" window="100,100,250,400" /><view id="16" visible="false" inframe="false" stylebar="false" location="1" size="150" window="50,50,500,500" /><view id="32" visible="false" inframe="false" stylebar="true" location="1" size="150" window="50,50,500,500" /><view id="64" toolbar="0" visible="false" inframe="true" stylebar="true" location="1" size="150" window="50,50,500,500" /><view id="70" toolbar="0 || 2020 || 2021 || 2022" visible="false" inframe="true" stylebar="true" location="1" size="150" window="50,50,500,500" /><view id="512" toolbar="0 | 1 501 5 19 , 67 | 2 15 45 18 , 7 37 | 514 3 9 , 13 44 , 47 | 16 51 | 551 550 11 ,  20 22 21 23 , 55 56 57 , 12 | 69 | 510 511 , 512 513 | 533 531 , 534 532 , 522 523 , 537 536 , 535 , 538 | 521 520 | 36 , 38 49 560 | 571 30 29 570 31 33 | 17 | 540 40 41 42 , 27 28 35 , 6 , 502" visible="true" inframe="false" stylebar="false" location="1" size="1134" window="100,100,600,400" /></views><toolbar show="true" items="0 39 73 62 | 1 501 67 , 5 19 , 72 75 76 | 2 15 45 , 18 65 , 7 37 | 4 3 8 9 , 13 44 , 58 , 47 | 16 51 64 , 70 | 10 34 53 11 , 24  20 22 , 21 23 | 55 56 57 , 12 | 36 46 , 38 49  50 , 71  14  68 | 30 29 54 32 31 33 | 25 17 26 60 52 61 | 40 41 42 , 27 28 35 , 6" position="1" help="false" /><input show="true" cmd="true" top="algebra" /><dockBar show="true" east="true" /></perspective></perspectives><labelingStyle  val="0"/><font  size="12"/></gui><euclidianView><viewNumber viewNo="1"/><coordSystem xZero="215.0" yZero="315.0" scale="50.0" yscale="50.0"/><evSettings axes="true" grid="true" gridIsBold="false" pointCapturing="3" rightAngleStyle="1" checkboxSize="26" gridType="3"/><bgColor r="255" g="255" b="255"/><axesColor r="0" g="0" b="0"/><gridColor r="192" g="192" b="192"/><lineStyle axes="1" grid="0"/><axis id="0" show="true" label="" unitLabel="" tickStyle="1" showNumbers="true"/><axis id="1" show="true" label="" unitLabel="" tickStyle="1" showNumbers="true"/></euclidianView><algebraView><mode val="3"/><auxiliary show="true"/></algebraView><kernel><continuous val="false"/><usePathAndRegionParameters val="true"/><decimals val="2"/><angleUnit val="degree"/><algebraStyle val="0" spreadsheet="0"/><coordStyle val="0"/></kernel><tableview min="-2.0" max="2.0" step="1.0"/><scripting blocked="false" disabled="false"/><euclidianView3D><coordSystem xZero="' + center[0] + '" yZero="' + center[1] + '" zZero="' + center[2] + '" scale="' + scale + '" xAngle="0" zAngle="0"/><evSettings axes="false" grid="false" gridIsBold="false" pointCapturing="3" rightAngleStyle="1" gridType="3"/><axis id="0" show="false" label="" unitLabel="" tickStyle="1" showNumbers="true"/><axis id="1" show="false" label="" unitLabel="" tickStyle="1" showNumbers="true"/><axis id="2" show="false" label="" unitLabel="" tickStyle="1" showNumbers="true"/><plate show="false"/><bgColor r="255" g="255" b="255"/><clipping use="false" show="false" size="1"/><projection type="0"/></euclidianView3D><construction title="" author="" date="">',
	...
	opacity = 1, //Opacity of faces.
	i, j; //For loop variables.

	//Adds vertices.
	for(i = 0; i < this.elementList[0].length; i++) {
		var coords = this.elementList[0][i].coordinates;
		file += '<element type="point3d" label="P_{' + i + '}"><show object="true" label="false" ev="4"/><objColor r="' + ptColor[0] + '" g="' + ptColor[1] + '" b="' + ptColor[2] + '" alpha="0.0"/><layer val="0"/><labelMode val="0"/><animation step="0.1" speed="1" type="1" playing="false"/><coords x="' + coords[0] + '" y="' + coords[1] + '" z="' + coords[2] + '" w="1.0"/><pointSize val="5"/></element>';
	}
	...
	for(i = 0; i < this.elementList[2].length; i++) {
		...
		var verts = this.faceToVertices(i);
		...
		edge -= verts.length;
		for(j = 0; j < verts.length; j++)
			file += '<element type="segment3d" label="e_{' + (edge++) + '}"><show object="true" label="false" ev="4"/><objColor r="' + edgeColor[0] + '" g="' + edgeColor[1] + '" b="' + edgeColor[2] + '" alpha="0.0"/><layer val="0"/><labelMode val="0"/><auxiliary val="false"/><lineStyle thickness="5" type="0" typeHidden="1"/><outlyingIntersections val="false"/><keepTypeOnTransform val="true"/></element>';
	}

	//Closing tags.
	file += '</construction></geogebra>';
	Polytope.fileName = Translation.firstToUpper(this.getName()) + ".ggb";
