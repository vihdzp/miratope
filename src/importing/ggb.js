...
Polytope.prototype.saveAsGGB = function(wireframe) {
	...
	if(proj) {
		//Adds text.
		//Rotation angles.
		file += '<expression label="txt1" exp="&quot;\\text{Rotation angles:}&quot;"/><element type="text" label="txt1"><show object="true" label="true" ev="40"/><objColor r="0" g="0" b="0" alpha="0.0"/><layer val="0"/><labelMode val="0"/><isLaTeX val="true"/><font serif="true" sizeM="1.0" size="0" style="0"/><startPoint x="-0.3" y="-0.2" z="1.0"/></element>';
		//Projection point.
		//y = d * (d - 1) / 2;
		//file += '<expression label="txt2" exp="&quot;\\text{Projection point:}&quot;"/><element type="text" label="txt2"><show object="true" label="true" ev="40"/><objColor r="0" g="0" b="0" alpha="0.0"/><layer val="0"/><labelMode val="0"/><isLaTeX val="true"/><font serif="true" sizeM="1.0" size="0" style="0"/><startPoint x="-0.3" y="' + (-y - 1.2) + '" z="1.0"/></element>';

		//Adds rotation sliders.
		y = -1.3;
		for(i = 0; i < d; i++)
			for(j = i + 1; j < d; j++) {
				file += '<element type="numeric" label="α_{' + i + ',' + j + '}"><value val="0"/><show object="true" label="true"/><objColor r="0" g="0" b="0" alpha="0.1"/><layer val="0"/><labelMode val="1"/><slider min="0" max="(2 * π)" width="4.0" x="0" y="' + y + '" fixed="false" horizontal="true" showAlgebra="true"/><lineStyle thickness="10" type="0" typeHidden="1"/><animation step="0.01" speed="1" type="0" playing="false"/><ggbscript onUpdate=""/></element>';
				y--;
			}
